...
/*
 *	Function Prototypes for Lance Interface:
 */

extern io_return_t	se_open(
				dev_t		dev,
				dev_mode_t	flag,
				io_req_t	ior);

extern io_return_t	se_output(
				dev_t		dev,
				io_req_t	ior);

extern io_return_t	se_get_status(
				dev_t			dev,
				dev_flavor_t		flavor,
				dev_status_t		status,
				mach_msg_type_number_t	*status_count);

extern io_return_t	se_set_status(
				dev_t			dev,
				dev_flavor_t		flavor,
				dev_status_t		status,
				mach_msg_type_number_t	status_count);

extern io_return_t	se_setinput(
				dev_t			dev,
