...
in 011111dddddaaaaasssss110011101Sr sradi{|.}[$r] $reg($a),$reg($s),$dec($[sssssS])
in 0111110000000000bbbbb01101100100 slbie $reg($b)
in 011111dddddaaaaabbbbbo0111u010wr div{d|w}[$w]{u|}[$u]{|o}[$o]{|.}[$r] \
				    $reg($d),$reg($a),$reg($b)
...
in 011111ddddd0rrrr0000010010100110 mfsr $reg($d),$dec($r)
...
# start with things from the 601 manual
spr 0000000000 mq
spr 0000100000 xer
...
spr 1111111111 pir
# from 603 manual
spr 11nnl10000 dbat$dec($n){u|l}[$l]
spr 1000011110 dmiss
spr 1000111110 dcmp
spr 1001n11110 hash{1|2}[$n]
spr 1010011110 imiss
spr 1010111110 icmp
spr 1011011110 rpa
# From 604 manual
spr 1100011101 mmcr0
spr 1100111101 pmc1
spr 1101011101 pmc2
spr 1101111101 sia
spr 1111111101 sda
