...
struct proc_dir_entry proc_osfmach3 = {
	PROC_OSFMACH3, 8, "osfmach3",
	S_IFDIR | S_IRUGO | S_IXUGO, 2, 0, 0,
	0, &proc_dir_inode_operations,
	NULL, NULL,
	NULL, &proc_root, NULL
...
#define proc_register(dir,a1,a2,a3,a4,a5,a6,a7,a8) \
{ \
	static struct proc_dir_entry xxx; \
	xxx = *(a1,a2,a3,a4,a5,a6,a7,a8); \
...
#ifdef	CONFIG_OSFMACH3
#undef	proc_register
#define proc_register(dir,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) \
{ \
	static struct proc_dir_entry xxx; \
...
#ifdef	CONFIG_OSFMACH3
	__proc_register(&proc_root, &proc_osfmach3);
	proc_osfmach3_init();
#endif	/* CONFIG_OSFMACH3 */
}
