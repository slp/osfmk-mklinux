...
#ifdef __PPC_SHLIB
/* PIC method of storing into errno, enable when shared libraries are
   supported.  */
#define __PPC_ERRNO							\
...
#define __PPC_ERRNO_CLOBBER , "r9", "r10", "lr"
#else
#define __PPC_ERRNO							\
	"lis 9,errno@ha\n\t"						\
	"stw 3,errno@l(9)"

#define __PPC_ERRNO_CLOBBER , "r9"
#endif

#define __PPC_SYSCALL(name,arg1,arg2,arg3,arg4,arg5)			\
do {									\
  int result;								\
  __asm__ volatile (_lisc(__NR_##name) "\n\t"					\
	   "sc\n\t"							\
	   "bns+ 1f\n\t"						\
	   __PPC_ERRNO "\n\t"						\
	   "li 3,-1\n"							\
...
type name(void) \
{ \
  __PPC_SYSCALL(name,0,0,0,0,0); \
}

#define _syscall1(type,name,type1,arg1) \
type name(type1 arg1) \
{ \
  __PPC_SYSCALL(name,arg1,0,0,0,0); \
}

#define _syscall2(type,name,type1,arg1,type2,arg2) \
type name(type1 arg1,type2 arg2) \
{ \
  __PPC_SYSCALL(name,arg1,arg2,0,0,0); \
}

#define _syscall3(type,name,type1,arg1,type2,arg2,type3,arg3) \
type name(type1 arg1,type2 arg2,type3 arg3) \
{ \
  __PPC_SYSCALL(name,arg1,arg2,arg3,0,0); \
}

#define _syscall4(type,name,type1,arg1,type2,arg2,type3,arg3,type4,arg4) \
type name (type1 arg1, type2 arg2, type3 arg3, type4 arg4) \
{ \
  __PPC_SYSCALL(name,arg1,arg2,arg3,arg4,0); \
} 
...
{ \
  __PPC_SYSCALL(name,arg1,arg2,arg3,arg4,arg5); \
}
...
/*  printk("unistd.h: clone(): flags = %x, esp = %x\n", flags, esp);*/
  __PPC_SYSCALL(clone,flags,esp,0,0,0);
}
